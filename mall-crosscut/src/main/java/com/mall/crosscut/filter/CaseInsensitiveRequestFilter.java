...
/**
 * Wrapper for an {@link HttpServletRequest} to make the lookup of parameters case insensitive.
 * The functionality is achieved by using the {@link LinkedCaseInsensitiveMap} from Spring.
 */
