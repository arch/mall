...
public class UmsGrowthChangeHistory implements Serializable {
    ...
    public UmsGrowthChangeHistory withId(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public UmsGrowthChangeHistory withMemberId(Long memberId) {
    ...
    public UmsGrowthChangeHistory withCreateTime(LocalDateTime createTime) {
    ...
    public UmsGrowthChangeHistory withChangeType(Integer changeType) {
    ...
    public UmsGrowthChangeHistory withChangeCount(Integer changeCount) {
    ...
    public UmsGrowthChangeHistory withOperateMan(String operateMan) {
    ...
    public UmsGrowthChangeHistory withOperateNote(String operateNote) {
    ...
    public UmsGrowthChangeHistory withSourceType(Integer sourceType) {
